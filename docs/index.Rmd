...
figure_caps(name = "Clickthrough Rates", caption = ifelse(is_html(), "Clickthrough rates of experimental groups, split by wiki. In the <span class=\"test-group-1\">Control</span> group...", "Clickthrough rates of experimental groups, split by wiki. In the Control group..."))
...
In Figures `r figure_caps("Clickthrough Rates", display = "num")` and `r figure_caps("BCDA H1", display = "num")`, we see that engagement was higher in <span class="test-group-2">Test</span> than in <span class="test-group-1">Control</span> on 4 of the 8 wikis (Arabic, French, Polish, and Russian Wikipedias) but lower on the other 4 (Italian, Persian, barely Catalan, and most drastically German Wikipedias).
